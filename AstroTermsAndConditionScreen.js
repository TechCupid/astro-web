...
const AstroTermsAndConditionsScreen = ({ navigation }) => {
  return (
  ...
  (hereinafter referred as “We” “TiS” “us” “our” “Tech Informatic Solutions
  application” “Website”).
</Text>
...
export default AstroTermsAndConditionsScreen;

const styles = StyleSheet.create({
  container: { 
    flex: 1, 
    backgroundColor: "#fff",
    // Prevents the main container from growing beyond the screen
    overflow: 'hidden', 
  },
  header: {
    flexDirection: "row",
  ...
  // ✅ FIX: This forces the ScrollView to actually scroll on Web browsers
  scrollArea: {
    flex: 1,
    ...Platform.select({
      web: {
  ...
  ...Platform.select({
    web: {
      flexBasis: 0,      // This tells the browser to stay within the box
