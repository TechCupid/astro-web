...
const OtpPage = ({ navigation, route }) => {
  ...
  console.log("🚀 OtpPage received mobileNumber:", mobileNumber); // ✅ Add this line
 ...
 const handleOtpVerification = async () => {
  ...
  try {
    ...
    if (response.status === 200) {
      ...
      const checkStore = await AsyncStorage.getItem('mobileNumber');
      console.log("📦 Just stored mobile number:", checkStore);
  ...
  const handleResendOtp = () => {
    ...
    setTimer(60);
    Alert.alert('OTP Resent', `OTP has been resent to +91 ${mobileNumber}`);
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Confirmation code has been sent to you on your mobile no +91 {mobileNumber}
      </Text>
